...
export async function POST(request: NextRequest) {
  try {
    ...
    // IMPORTANT: Convert string to Uint8Array byte-by-byte to preserve MASAV Hebrew encoding
    // JavaScript strings are UTF-16, but MASAV needs single-byte encoding
